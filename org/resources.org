...
#+begin_src js :mkdirp yes :tangle js/main.js
  function insert_top_banner() {
      ...
      new_html += "<button onClick=\"window.location.href='/lensr_blog_v1/'\">Home</button>";
      ...
      new_html += "<button onClick=\"window.location.href='https://www.github.com/LensPlaysGames'\">GitHub</button>";
